    ...
    <header className="space-y-4 border-b border-black/10 pb-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.25em] text-gl-gold">
        ...
        <a
          ...
          className="rounded-xl border border-black/15 bg-white px-4 py-2 text-sm font-medium hover:bg-neutral-50"
        >
          Open store
        </a>
      </div>
